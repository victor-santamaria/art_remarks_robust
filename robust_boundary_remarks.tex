...
\iint_{\mathcal O_d\times(0,T)}\rho^2|y_d|^2dxdt<+\infty,
\end{equation}
we can find a leader control $h\in \magenta{X}$ and a unique follower control $\bar v$ minimizing \eqref{func_teo3}, such that the associated solution to \eqref{func_teo3} verifies $w(\cdot,T)=0$. 
\end{theorem}

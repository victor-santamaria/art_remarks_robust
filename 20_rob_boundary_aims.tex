...
\hyphenation{ins-ti-tut}



%% Place the running title of the paper with 40 letters or less in []
 %% and the full title of the paper in { }.
\title[Robust Stackelberg controllability for the heat equation] %Use the shortened version of the full title
...
\subjclass{Primary: 49J20, 93B05, 49K35.}
% Please provide minimum  5 keywords.
 \keywords{Hierarchic control, robust control, Carleman estimates, boundary controllability, heat equation.}

% Email address of each of all authors is required.
% You may list email addresses of all other authors, separately.
 \email{victor.santamaria@math.univ-toulouse.fr}
 \email{liliana\_peralta@uaeh.edu.mx}
...
\thanks{The first author is supported by project IN102116 of DGAPA,
UNAM (Mexico).}
...
%\thanks{$^*$ Corresponding author: V\'ictor Hern\'andez-Santamar\'ia}
...
\end{equation*}
%
Note that from the definition of the weight functions \eqref{weights_l}, we have that $\alpha$ and $\alpha^*$ are equal in $\partial \Omega$, thus we may write
%
\begin{equation*}
\begin{split}
...
&\leq s^{-\frac{1}{2}}\left\| e^{-s\alpha^*}(\xi^*)^{-\frac{1}{4}} \varphi \right\|^2_{H^{2,1}(Q)},
\end{split}
\end{equation}
%
...
\begin{split}
s^{-\frac{1}{2}}&\left\| e^{-s\alpha^*}(\xi^*)^{-\frac{1}{4}} \varphi \right\|^2_{H^{2,1}(Q)}\\
...
%
\begin{equation*}\int_{\Omega}\left(\theta_t-\theta \Delta \theta\right) e^{-2s\widehat{\beta_2}}\theta \dx=\int_{\Omega}\left(-\frac{1}{\ell^2}\varphi\csin{\mathcal B_1}+\frac{1}{\gamma^2}\varphi \csin{\mathcal B_2}\right)e^{-2s\widehat{\beta_2}}\theta\dx.\end{equation*}
...
&=\int_{\Omega}\left(-\frac{1}{\ell^2}\varphi\csin{\mathcal B_1}+\frac{1}{\gamma^2}\varphi \csin{\mathcal B_2}\right)e^{-2s\widehat{\beta_2}}\theta\dx-s\int_{\Omega}e^{-2s\widehat{\beta_2}}(\widehat{\beta_2})_t|\theta|^2\dx.
\end{split}
\end{equation}
%
...
\label{aux8}
\begin{split}
\frac12\frac{d}{dt}&\int_{\Omega}e^{-2s\widehat{\beta_2}}|\theta|^2\dx+\int_{\Omega}e^{-2s\widehat{\beta_2}}|\triangledown \theta|^2\dx\\
...
\end{equation}
 %
and applying Gronwall's lemma to \eqref{aux8} followed by integration in time yields
 %
...
Let us choose any function $\rho_\star\in C^\infty([0,T])$, such that $\rho_\star(t)\geq e^{\frac{s\bar\alpha}{2}}$ with $\bar \alpha$ defined as
%
\begin{equation*}
...
&\leq C\left(\iint_{Q}e^{-2s\bar\alpha}|\theta\chi_{\mathcal O_d}|^2\dx\dt+\iint_{\mathcal S^\prime\times(0,T)}e^{-2s\bar\alpha}s\bar\xi\left|\frac{\partial \varphi}{\partial n}\right|^2\dx\dt\right)
\end{split}
\end{equation}
%
...
\bibitem{assia_survey} (MR2846087) [10.3934/mcrf.2011.1.267]
\newblock {F. Ammar-Khodja, A. Benabdallah, M. Gonz\'alez-Burgos and L. de Teresa,}
\newblock \doititle{Recent results on the controllability of linear coupled parabolic problems: a survey},
\newblock \emph{Math. Control Relat. Fields}, \textbf{1} (2011),  267--306.

\bibitem{assia_luz_new} (MR3535750) [10.1016/j.jmaa.2016.06.058]
\newblock {F. Ammar-Khojda, A. Benabdallah, M. Gonz\'alez-Burgos and L. de Teresa,}
\newblock \doititle{New phenomena for the null controllability of parabolic systems: Minimal time and geometrical dependence},
\newblock \emph{J. Math. Anal. Appl.}, \textbf{444} (2016), 1071--1113.

\bibitem{a_araujo} (MR3849151) [10.1007/s00498-018-0220-6]
\newblock {F. D. Araruna, B. S. V. Ara\'ujo and E. Fern\'andez-Cara,}
\newblock \doititle{Stackelberg-Nash null controllability for some linear and semilinear degenerate parabolic equations},
\newblock \emph{Math. Control Signals Systems}, \textbf{30} (2018), Art. 14, 31 pp.

\bibitem{araruna} (MR3358632) [10.1051/cocv/2014052]
\newblock {F. D. Araruna, E. Fern\'andez-Cara and M. C. Santos,}
\newblock \doititle{{S}tackelberg-{N}ash exact controllability for linear and semilinear parabolic equations},
\newblock \emph{ESAIM: Control Optim. Calc. Var.}, \textbf{21} (2015), 835--856.

\bibitem{araruna1} (MR3652397) [10.1016/j.sysconle.2017.03.009]
\newblock {F.D. Araruna, E. Fern\'andez-Cara, S. Guerrero and M. C. Santos,}
\newblock \doititle{New results on the Stackelberg Nash exact controllability for parabolic equations},
\newblock \emph{Systems} \& \emph{Control Letters}, \textbf{104} (2017), 78--85.

\bibitem{da_silva} (MR3818372) [10.1007/s10957-018-1277-6]
\newblock {F. D. Araruna, E. Fern\'andez-Cara and L. C. da Silva},
\newblock \doititle{Hierarchical exact controllability of semilinear parabolic equations with distributed and boundary controls},
\newblock \emph{J. Optim. Theory Appl.,} \textbf{178} (2018), 264--288.

\bibitem{aziz} (MR2038995)
\newblock {A. Belmiloudi,}
...
\bibitem{temam}
\newblock {T. R. Bewley, R. Temam and M. Ziane,}
...
\bibitem{temam_nonlinear} (MR1744637) [10.1016/S0167-2789(99)00206-7]
\newblock {T. R. Bewley, R. Temam and M. Ziane,}
\newblock \doititle{A general framework for robust control in fluid mechanics},
\newblock \emph{Physica D}, \textbf{138} (2000), 360--392.

\bibitem{boyer_HUM} (MR3174955) [10.1051/proc/201341002]
\newblock {F. Boyer,}
\newblock \doititle{On the penalised HUM approach and its applications to the numerical approximation of null-controls for parabolic problems},
\newblock \emph{ESAIM Proceedings,} \textbf{41} (2013), 15--58.

\bibitem{carreno} (MR3912775) [10.1016/j.jde.2018.10.043]
\newblock {N. Carre\~{n}o and M. C. Santos},
\newblock \doititle{Stackelberg-Nash exact controllability for the Kuramoto-Sivashinsky equation},
\newblock \emph{J. Differential Equations}, \textbf{266} (2019), 6068--6108.

\bibitem{duprez_lissy} (MR3550851) [10.1016/j.matpur.2016.03.016]
\newblock {M. Duprez and P. Lissy,}
\newblock \doititle{Indirect controllability of some linear parabolic systems of $m$ equations with $m-1$ controls involving coupling terms of zero or first order},
\newblock \emph{J. Math. Pures Appl.}, \textbf{9} (2016), 905--934.

\bibitem{Ekeland} (MR0463994)
\newblock {I. Ekeland and R. Temam,}
\newblock \emph{Convex Analysis and Variational Problems,}
\newblock North-Holland, 1976.

\bibitem{ima_original} (MR1349016) [10.1070/SM1995v186n06ABEH000047]
\newblock {O. Yu. \`{E}manuilov,}
\newblock \doititle{Controllability of parabolic equations},
\newblock (Russian)\emph{Sb. Math.}, \textbf{186} (1995),  879--900.

\bibitem{evans} (MR1625845)
\newblock {L. C. Evans,}
...
\bibitem{cara_guerrero} (MR2257228) [10.1137/S0363012904439696]
\newblock {E. Fern\'andez-Cara and S. Guerrero,}
\newblock \doititle{Global {C}arleman inequalities for parabolic systems and applications to controllability},
\newblock \emph{SIAM J. Control Optim.}, \textbf{45} (2006), 1399--1446.

\bibitem{cara_NS} (MR2103189) [10.1016/j.matpur.2004.02.010]
\newblock {E. Fern\'andez-Cara, S. Guerrero, O. Yu. Imanuvilov and J. P. Puel,}
\newblock \doititle{Local exact controllability of the Navier-Stokes system},
...
\bibitem{fursi} (MR1406566)
\newblock {A. Fursikov and O. Yu. Imanuvilov,}
...
\bibitem{glo_lions_he} (MR2404764) [10.1017/CBO9780511721595]
\newblock {R. Glowinski, J.-L. Lions and J. He,}
...
\bibitem{luz_manuel} (MR2598471) [10.4171/PM/1859]
\newblock {M. Gonz\'alez-Burgos and L. de Teresa,}
\newblock \doititle{Controllability results for cascade systems of $m$ coupled parabolic PDEs by one control force},
\newblock \emph{Port. Math.,} \textbf{67} (2010), 91--113.

\bibitem{Guillen} (MR3020861) [10.1090/S0002-9939-2012-11459-5]
\newblock {F. Guill\'en-Gonz\'alez, F. Marques-Lopes and M. Rojas-Medar,}
\newblock \doititle{On the approximate controllability of {S}tackelberg-{N}ash strategies for {S}tokes equations},
\newblock \emph{Proc. Amer. Math. Soc.}, \textbf{141} (2013), 1759--1773.

\bibitem{vhs_corri} (MR3734411) [10.4171/PM/1998]
\newblock {V. Hern\'andez-Santamar\'ia, L. de Teresa and A. Poznyak},
\newblock \doititle{Corrigendum and addendum to ``Hierarchic control for a coupled parabolic system''}, \emph{Portugaliae Math.,} \textbf{73} (2016), 115--137.
\newblock \emph{Port. Math.}, \textbf{74} (2017),  161--168.

\bibitem{vhs_deT_rob} (MR3810195) [10.3934/eect.2018012]
\newblock {V. Hern\'andez-Santamar\'ia and L. de Teresa,}
\newblock \doititle{Robust Stackelberg controllability for linear and semilinear heat equations},
\newblock \emph{Evol. Equ. Control Theory}, \textbf{7} (2018), 247--273.

\bibitem{vhs_honor} (MR3888959)
\newblock {V. Hern\'andez-Santamar\'ia and L. de Teresa},
...
\bibitem{ima_yama_boundary} (MR2529443) [10.1007/s11401-008-0280-x]
\newblock {O. Yu. Imanuvilov, J. P. Puel and M. Yamamoto,}
\newblock \doititle{Carleman estimates for parabolic equations with nonhomogeneous boundary conditions},
\newblock \emph{Chin. Ann. Math. Ser. B}, \textbf{30} (2009), 333--378.

\bibitem{ima_yama} (MR1987865) [10.2977/prims/1145476103]
\newblock {O. Yu. Imanuvilov and M. Yamamoto,}
\newblock \doititle{Carleman inequalities for parabolic equations in {S}obolev spaces of negative order and exact controllability for semilinear parabolic equations},
\newblock \emph{Publ. RIMS, Kyoto Univ.}, \textbf{39} (2003), 227--274.

\bibitem{jesus} (MR3842128) [10.1007/s10883-018-9413-z]
\newblock {I. P. de Jesus, J. Limaco and M. R. Clark,}
\newblock \doititle{Hierarchical control for the one-dimensional plate equation with a moving boundary},
\newblock \emph{J. Dyn. Control Syst.}, \textbf{24} (2018), 635--655.

\bibitem{Lions_optim} (MR0271512)
\newblock {J.-L. Lions,}
...
\bibitem{LionsHier} (MR1280077) [10.1007/BF02830893]
\newblock {J.-L. Lions,}
\newblock \doititle{Hierarchic control},
\newblock \emph{Proc. Indian Acad. Sci. Math. Sci.,} \textbf{104} (1994), 295--304.

\bibitem{LionsSta} (MR1291134) [10.1142/S0218202594000273]
\newblock {J.-L. Lions,}
\newblock \doititle{Some remarks on {S}tackelberg's optimization},
\newblock \emph{Math. Models Methods Appl. Sci.}, \textbf{4} (1994), 477--487.

\bibitem{lions_magenes} (MR0350177)
\newblock {J.-L. Lions and E. Magenes,}
...
\bibitem{montoya} (MR3846862) [10.1007/s00030-018-0537-3]
\newblock  {C. Montoya and L. de Teresa,}
\newblock \doititle{Robust Stackelberg controllability for the Navier-Stokes equations},
\newblock \emph{NoDEA Nonlinear Differential Equations Appl.}, \textbf{25} (2018), Art. 46, 33 pp.

\bibitem{pighin} (MR3917471) [10.3934/mcrf.2018041]
\newblock {D. Pighin and E. Zuazua,}
\newblock \doititle{Controllability under positivity constraints of semilinear heat equations},
\newblock \emph{Math. Control. Relat. F.}, \textbf{8} (2018), 935--964.

\bibitem{simon} (MR916688) [10.1007/BF01762360]
\newblock {J. Simon,}
\newblock \doititle{Compact sets in the space $L^p(0,T;B)$},
\newblock \emph{Ann. Mat. Pura Appl.}, \textbf{146} (1987), 65--96.

\bibitem{Stackelber}
\newblock {H. von Stackelberg,}
\newblock \emph{Marktform und {G}leichgewicht},
\newblock Springer, 1934.

\bibitem{deteresa2000} (MR1737542) [10.1080/03605300008821507]
\newblock {L. de Teresa,}
\newblock \doititle{Insensitizing controls for a semilinear heat equation},
\newblock \emph{Comm. Partial Differential Equations}, \textbf{25} (2000), 39--72.

\bibitem{trelat} (MR2957013) [10.1007/s10957-012-0050-5]
\newblock {E. Tr\'elat,}
\newblock \doititle{Optimal control and applications to aerospace: Some results and challenges},
\newblock \emph{J. Optim. Theory Appl.}, \textbf{154} (2012), 713--758.

\bibitem{trol} (MR2583281) [10.1090/gsm/112]
\newblock {F. Tr\"oltzsch,}

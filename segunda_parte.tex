...
&\quad+\left.\iint_{Q}e^{-2s\tilde{\alpha_1}}(s\tilde{\xi})^m|-\frac{1}{\ell^2}\varphi\csin{\mathcal B_1}+\frac{1}{\gamma^2}\varphi|^2\dx\dt+\iint_{\Sigma^{\prime}}e^{-2s\tilde{\alpha}}(s\tilde{\xi})^{1+m}\left|\frac{\partial \theta}{\partial n}\right|^2\dx\dt\right)\\
&\leq C\left(\iint_{\Sigma^{\prime}}e^{-2s\tilde{\alpha}}(s\tilde{\xi})^{1+m}\left|\frac{\partial \varphi}{\partial n}\right|^2\dx\dt+\iint_{\Sigma^{\prime}}e^{-2s\tilde{\alpha}}(s\tilde{\xi})^{1+m}\left|\frac{\partial \theta}{\partial n}\right|^2\dx\dt\right).
\end{align}
%
where
\begin{equation*}
\begin{split}
I(\varphi)&:=\iint_{Q}e^{-2s\tilde{\alpha}}(s\tilde{\xi})^{1+m}|\nabla \varphi|^2\dx\dt+\iint_{Q}e^{-2s\tilde{\alpha}}(s\tilde{\xi})^{3+m}|\varphi|^2\dx\dt,\\
I(\theta)&:=\iint_{Q}e^{-2s\tilde{\alpha}}(s\tilde{\xi})^{1+m}|\nabla \theta|^2\dx\dt+\iint_{Q}e^{-2s\tilde{\alpha}}(s\tilde{\xi})^{3+m}|\theta|^2\dx\dt
\end{split}
\end{equation*}

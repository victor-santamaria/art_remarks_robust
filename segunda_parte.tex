...
\begin{equation*}\int_{\Omega}\left(\theta\theta_t-\theta\Delta \theta\right)\dx=\int_{\Omega}\left(-\frac{1}{\ell^2}\varphi\csin{\mathcal B_1}+\frac{1}{\gamma^2}\varphi\right)\theta\dx,\end{equation*}
%
and we use the equality $\theta\theta_t=\frac{1}{2}\frac{d}{dt}|\theta|^2$ to get,

\begin{align}\label{aux3}
\frac{1}{2}\frac{d}{dt}\int_{\Omega}|\theta|^2\dx+\int_{\Omega}|\triangledown \theta|^2\dx&=\int_{\Omega}\left(-\frac{1}{\ell^2}\varphi\csin{\mathcal B_1}+\frac{1}{\gamma^2}\varphi\right)\theta\dx, 
\end{align}
then applying H\"older and young's inequalities we get,

\begin{align}\label{aux3}
\frac{1}{2}\frac{d}{dt}\int_{\Omega}|\theta|^2\dx+\int_{\Omega}|\triangledown \theta|^2\dx&\leq C\left(\frac{1}{\ell^4}\int_{\mathcal B_1}|\varphi|^2\dx+\frac{1}{\gamma^4}\int_{\Omega}|\varphi|^2\dx\right)+\frac12 \int_{\Omega}|\theta|^2\dx
\end{align}

Applying Gronwall's inequality in \eqref{aux3}, integrating in $[0,T/2]$ and using that \magenta{$ \mathcal {B}_1\subset\Omega$} we have,

\begin{align}\label{aux4}
\int_{0}^{T/2}\int_{\Omega}|\theta|^2\dx\dt\leq C(T)\frac{1}{\mu}\int_{0}^{T/2}\int_{\Omega}|\varphi|^2\dx\dt,
\end{align}
%
where $\mu=\min\{\ell^4,\gamma^4\}$.

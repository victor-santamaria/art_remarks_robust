...
\begin{equation}\tilde{\xi}=\frac{e^{\lambda\eta(x)}}{t^2(T-t)^2}\qquad \Sigma^{\prime}=S^{\prime}\times (0,T)\end{equation}
\end{notation}

\begin{proposition}
\magenta{Under the hypotheses ....}. Then, there exists a constant $C$ \magenta{maybe $\sigma$, $s$ large enough} such that
%
...
\begin{align}\notag
&\iint_{Q}e^{-2s\tilde{\alpha}}(s\tilde{\xi})^{1+m}|\nabla \varphi|^2\dx\dt+\iint_{Q}e^{-2s\tilde{\alpha}}(s\tilde{\xi})^{3+m}|\varphi|^2\\ \notag
&+\iint_{Q}e^{-2s\tilde{\alpha}}(s\tilde{\xi})^{1+m}|\nabla \theta|^2\dx\dt+\iint_{Q}e^{-2s\tilde{\alpha}}(s\tilde{\xi})^{3+m}|\theta|^2\\ \notag
&\leq C\left(\iint_{Q}e^{-2s\tilde{\alpha}}(s\tilde{\xi})^m|\theta|^2\dx\dt+\iint_{\Sigma^{\prime}}e^{-2s\tilde{\alpha}}(s\tilde{\xi})^{1+m}\left|\frac{\partial \varphi}{\partial n}\right|^2\dx\dt\right.\\
&\quad+\left.\iint_{Q}e^{-2s\tilde{\alpha}}(s\tilde{\xi})^m|-\frac{1}{\ell^2}\varphi\csin{\mathcal B_1}+\frac{1}{\gamma^2}\varphi|^2\dx\dt+\iint_{\Sigma^{\prime}}e^{-2s\tilde{\alpha}}(s\tilde{\xi})^{1+m}\left|\frac{\partial \theta}{\partial n}\right|^2\dx\dt\right)\\

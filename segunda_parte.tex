...
\theta(x,0)=\theta^0(x), \quad \varphi(x,T)=\varphi^T(x)& \text{in } \Omega,
\end{cases}
\end{equation}
%
...
F_{\epsilon}()=\frac{1}{2}\iint_{\partial \Omega\times(0,T)}|\frac{\partial}{}|^2\dx\dt+\frac{1}{2}\left[\ell^2\iint_{\partial \Omega\times(0,T)}|v|^2\d\sigma\dt-\gamma^2\iint_Q|\psi|^2\dx\dt\right]
\end{equation}

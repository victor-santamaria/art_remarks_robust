...
&\quad+\left.\iint_{Q}e^{-2s\tilde{\alpha}_2}(s\tilde{\xi}_2)^{-1}|-\frac{1}{\ell^2}\varphi\csin{\mathcal B_1}+\frac{1}{\gamma^2}\varphi|^2\dx\dt+\iint_{\Sigma^{\prime}}e^{-2s\tilde{\alpha}_2}\left|\frac{\partial \theta}{\partial n}\right|^2\dx\dt\right)\\
...
\end{equation*}
Note that we can replace $\tilde{\xi}_i, \tilde{\alpha}_i$ by $\beta_i, \phi_i$ in the interval $[T/2,T]$ hence,
